...
RUN apt-get install -y libcap-dev   libsqlite3-0 libpcap0.8 libpcap-dev libseccomp-dev libdb4.8-dev libdb4.8++-dev libtool autotools-dev automake pkg-config libssl-dev libevent-dev \
